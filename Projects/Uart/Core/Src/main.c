...
#if 0 // default option as in the example
  RCC->AHB1ENR |= RCC_AHB1ENR_GPIOAEN;
  RCC->AHB1ENR |= RCC_AHB1ENR_GPIOBEN;

  GPIOA->MODER |= (0b10 << 9*2); // PA9 (for write)
//  GPIOA->MODER |= (0b10 << 10*2); // PA10
  GPIOB->MODER |= (0b10 << 7*2); // PB7 (for read)



  GPIOA->AFR[1] |= (0b111 << (4 * (9-8)));
//  GPIOA->AFR[1] |= (0b111 << (4 * (10-8)));
...
//  uint8_t BUF_SIZE = 10;
//  uint8_t write_buf[BUF_SIZE], read_buf[BUF_SIZE];
  uint8_t data = 0;
  uint8_t i = 0;
